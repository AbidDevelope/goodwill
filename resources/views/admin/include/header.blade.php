                  ...
                  <li>
                     ...
                     <a class="dropdown-item" href="#">
                       ...
                       <div class="d-flex align-items-center">
                          ...
                          <img src="{{asset('public/admin/assets/images/avatars/avatar-1.png')}}" alt="" class="rounded-circle" width="60" height="60">
                    ...
                    <li>
                      ...
                      <a class="dropdown-item" href="index2.html">
                         ...
                         <div class="d-flex align-items-center">
                           ...
                           <div class="setting-text ms-3"><span>Admin Dashboard</span></div>
                 ...
                 <div class="header-message-list p-2">
                    ...
                    <div class="dropdown-item bg-light radius-10 mb-1">
                     ...
                     <a class="dropdown-item" href="#">
                       ...
                       <div class="d-flex align-items-center">
                          ...
                          <img src="{{asset('public/admin/assets/images/avatars/avatar-1.png')}}" alt="" class="rounded-circle" width="52" height="52">
                    ...
                    <a class="dropdown-item" href="#">
                      ...
                      <div class="d-flex align-items-center">
                         ...
                         <img src="{{asset('public/admin/assets/images/avatars/avatar-2.png')}}" alt="" class="rounded-circle" width="52" height="52">
                    ...
                    <a class="dropdown-item" href="#">
                      ...
                      <div class="d-flex align-items-center">
                         ...
                         <img src="{{asset('public/admin/assets/images/avatars/avatar-3.png')}}" alt="" class="rounded-circle" width="52" height="52">
                    ...
                    <a class="dropdown-item" href="#">
                      ...
                      <div class="d-flex align-items-center">
                         ...
                         <img src="{{asset('public/admin/assets/images/avatars/avatar-4.png')}}" alt="" class="rounded-circle" width="52" height="52">
                    ...
                    <a class="dropdown-item" href="#">
                      ...
                      <div class="d-flex align-items-center">
                         ...
                         <img src="{{asset('public/admin/assets/images/avatars/avatar-5.png')}}" alt="" class="rounded-circle" width="52" height="52">
                    ...
                    <a class="dropdown-item" href="#">
                      ...
                      <div class="d-flex align-items-center">
                         ...
                         <img src="{{asset('public/admin/assets/images/avatars/avatar-6.png')}}" alt="" class="rounded-circle" width="52" height="52">
