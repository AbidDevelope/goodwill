                        ...
                        <header class="card-header">
                            <div class="row align-items-center">
                                <div class="col-lg-6 col-md-6 mb-lg-0 mb-15">
                                    <span>
                                        <i class="material-icons md-calendar_today"></i> <b>Wed, Aug 13, 2022,
                                            4:34PM</b>
                                    </span> <br>
                                ...
                                <div class="col-lg-6 col-md-6 ms-auto text-md-end">
                                    <a class="btn btn-primary" href="#"> <i
                                            class="fa-solid fa-cloud-arrow-down"></i>Save PDF</a>
                                                            ...
                                                            <p>
                                                                ...
                                                                <a href="#">
                                                                    <span class="__cf_email__"
                                                                        data-cfemail="8be1e4e5e5f2efeeededcbece6eae2e7a5e8e4e6">[email&#160;protected]</span>
                                                                </a>
                                                            </p>
                                                        </div>
                                                        <div class="col-sm-6 text-end">
                                                            ...
                                                            <p>
                                                                ...
                                                                <a href="#">
                                                                    <span class="__cf_email__"
                                                                        data-cfemail="49233c28272f2c3b092e24282025672a2624">[email&#160;protected]</span>
                                                                </a>
                                                            </p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="line-items">
                                                    ...
                                                    <div class="total text-end">
                                                        <p class="extra-notes">
                                                            ...
                                                            Please send all items at the same time to shipping address
                                                            by next week.
                                                            Thanks a lot.
                                                        </p>
                                                        <div class="field">
